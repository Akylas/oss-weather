...
export class CustomTransition extends Transition {
    public createAndroidAnimator(
        ...
        objectAnimators[0] = android.animation.ObjectAnimator.ofFloat(
            null,
            'scaleX',
            scaleValues
        );
        objectAnimators[1] = android.animation.ObjectAnimator.ofFloat(
            null,
            'scaleY',
            scaleValues
        );
        objectAnimators[2] = android.animation.ObjectAnimator.ofFloat(
            null,
            'alpha',
            opacityValues
        );
