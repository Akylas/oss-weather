        ...
        Column(
            ...
            Column(
                ...
                Text(
                    ...
                    style = TextStyle(fontSize = (size.width.value * 0.2).sp, fontWeight = FontWeight.Bold, color = GlanceTheme.colors.onSurface)
                )
            }
            Text(
        ...
        Box(
            ...
            Row(
                ...
                Column(
                    ...
                    Text(
                        text = data.temperature,
                        style = TextStyle(fontSize = min((size.width.value * 0.16), 30).sp, fontWeight = FontWeight.Bold, color = GlanceTheme.colors.onSurface)
                    )
                }
                Column(
                    modifier = GlanceModifier.fillMaxWidth().fillMaxHeight(),
