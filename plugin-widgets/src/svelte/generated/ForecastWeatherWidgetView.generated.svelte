    ...
    <stacklayout orientation="vertical">
        <gridlayout paddingLeft={10} paddingRight={10} paddingTop={6} paddingBottom={6} columns="auto,*,auto" horizontalAlignment="center" verticalAlignment="top">
            <stacklayout orientation="vertical" col={0} verticalAlignment="top" horizontalAlignment="left">
                <label text={data.locationName} fontSize={12} opacity={0.6} textAlignment="left" maxLines={1} horizontalAlignment="left" verticalAlignment="top"></label>
            ...
            <stacklayout orientation="vertical" col={2} verticalAlignment="top" horizontalAlignment="left">
                ...
                <label text={data.description} fontSize={11} opacity={0.6} textAlignment="right" maxLines={1} visibility={(data.description != null) ? 'visible' : 'collapsed'} horizontalAlignment="right" verticalAlignment="bottom"></label>
            </stacklayout>
        </gridlayout>
        <absolutelayout height={8} horizontalAlignment="center" verticalAlignment="top"></absolutelayout>
            <label text={lc('hourly')} textAlignment="left" fontSize={12} fontWeight={medium} opacity={0.6} paddingLeft={8} paddingRight={8} horizontalAlignment="left" verticalAlignment="top"></label>
        ...
        <collectionview items={data.hourlyData?.slice(0, 8)} showIndicators={false} orientation="horizontal" colWidth="auto" horizontalAlignment="center" verticalAlignment="top">
            ...
            <stacklayout width={53} padding={2} paddingLeft={4} paddingRight={4} orientation="vertical">
                <label text={item.time} fontSize={10} opacity={0.6} maxLines={1} horizontalAlignment="center" verticalAlignment="center"></label>
                ...
                <label text={item.temperature} fontSize={12} fontWeight={bold} color={colorOnSurface} maxLines={1} horizontalAlignment="center" verticalAlignment="center"></label>
                <label text={item.precipAccumulation} fontSize={9} opacity={0.6} visibility={(item.precipAccumulation != null) ? 'visible' : 'collapsed'} horizontalAlignment="center" verticalAlignment="center"></label>
            </stacklayout>
            </Template>
        </collectionview>
        <absolutelayout height={16} horizontalAlignment="center" verticalAlignment="top"></absolutelayout>
            <label text={lc('daily')} textAlignment="left" fontSize={12} fontWeight={medium} opacity={0.6} paddingLeft={8} paddingRight={8} horizontalAlignment="left" verticalAlignment="top"></label>
        <absolutelayout height={4} horizontalAlignment="center" verticalAlignment="top"></absolutelayout>
                    ...
                    <gridlayout columns="auto,*,auto,*,auto" horizontalAlignment="center" verticalAlignment="center">
                        ...
                        <stacklayout orientation="vertical" col={4} verticalAlignment="center" horizontalAlignment="center">
                            <stacklayout padding={6} orientation="horizontal" horizontalAlignment="right" verticalAlignment="bottom">
                                ...
                                <label text={item.temperatureLow} fontSize={13} opacity={0.6} maxLines={1} verticalAlignment="center" horizontalAlignment="right"></label>
                            </stacklayout>
                            <stacklayout padding={6} orientation="horizontal" horizontalAlignment="right" verticalAlignment="bottom">
                                <label text={item.precipAccumulation} fontSize={10} opacity={0.6} visibility={(item.precipAccumulation != null) ? 'visible' : 'collapsed'} verticalAlignment="center" horizontalAlignment="right"></label>
                                <label text={"💧" + item.precipitation} fontSize={10} opacity={0.6} visibility={(item.precipitation != null) ? 'visible' : 'collapsed'} verticalAlignment="center" horizontalAlignment="right"></label>
                            </stacklayout>
                        </stacklayout>
                    </gridlayout>
                </stacklayout>
