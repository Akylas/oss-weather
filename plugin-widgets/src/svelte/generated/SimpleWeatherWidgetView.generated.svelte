...
<gridlayout width={size.width} height={size.height} {...$$restProps} class="widget-container">
    {#if size.width < 120}
        <stacklayout padding={3} orientation="vertical">
            ...
            <label text={data.locationName} fontSize={8} opacity={0.5} maxLines={1} horizontalAlignment="center"></label>
        </stacklayout>
    {:else}
        <gridlayout paddingLeft={10} paddingRight={10} paddingTop={6} paddingBottom={6}>
            <label text={data.locationName} fontSize={12} opacity={0.5} horizontalAlignment="left" maxLines={1}></label>
