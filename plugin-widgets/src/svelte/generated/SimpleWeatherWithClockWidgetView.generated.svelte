        ...
        <gridlayout paddingLeft={10} paddingRight={10} paddingTop={6} paddingBottom={6}>
            <gridlayout columns="*,auto">
                <stacklayout orientation="vertical" col={0} verticalAlignment="center" horizontalAlignment="center">
                    <label fontSize={Math.min(size.width * 0.15, 50)} fontWeight={config.settings?.clockBold === true ? "bold" : "normal"} color={widgetColor} text={nowTime()} horizontalAlignment="left" verticalAlignment="center"></label>
                    <absolutelayout height={4} horizontalAlignment="left" verticalAlignment="center"></absolutelayout>
                    <label fontSize={14} opacity={0.5} color={widgetColor} text={formatDate(new Date(), 'll')} horizontalAlignment="left" verticalAlignment="center"></label>
                </stacklayout>
