        ...
        <gridlayout paddingLeft={10} paddingRight={10} paddingTop={6} paddingBottom={6}>
            <gridlayout columns="*,auto">
                <stacklayout orientation="vertical" col={0} verticalAlignment="center" horizontalAlignment="center">
                    ...
                    <label fontSize={14} opacity={0.6} color={widgetColor} text={formatDate(new Date(), 'll')} horizontalAlignment="left" verticalAlignment="center"></label>
                </stacklayout>
                ...
                <label text={data.locationName} fontSize={12} opacity={0.6} maxLines={1} color={widgetColor} horizontalAlignment="left" verticalAlignment="top"></label>
                <label text={data.description} fontSize={12} opacity={0.6} textAlignment="right" color={widgetColor} verticalAlignment="bottom" horizontalAlignment="right" visibility={(data.description != null) ? 'visible' : 'collapsed'}></label>
        </gridlayout>
    {:else}
        <gridlayout padding={3}>
            ...
            <gridlayout rows="*,auto">
                <label text={data.locationName} fontSize={size.width < 100 ? 8 : size.width < 150 ? 10 : 12} opacity={0.6} maxLines={1} color={widgetColor} row={1} horizontalAlignment="right" verticalAlignment="bottom"></label>
            </gridlayout>
        </gridlayout>
    {/if}
</gridlayout>
