        ...
        <gridlayout paddingLeft={10} paddingRight={10} paddingTop={6} paddingBottom={6}>
            <gridlayout padding={8} columns="auto,*,auto">
                <stacklayout orientation="vertical" col={0} verticalAlignment="center" horizontalAlignment="center">
                    <label fontSize={Math.min(size.width * 0.17, 48)} fontWeight={config.settings?.clockBold === true ? "bold" : "normal"} color={widgetColor} text={formatDateWithoutYear(new Date(), 'll')} horizontalAlignment="left" verticalAlignment="center"></label>
                    <absolutelayout height={4} horizontalAlignment="left" verticalAlignment="center"></absolutelayout>
                    <label fontSize={14} opacity={0.5} color={widgetColor} text={formatDate(new Date(), 'YYYY')} horizontalAlignment="left" verticalAlignment="center"></label>
                </stacklayout>
                <stacklayout orientation="vertical" col={2} verticalAlignment="center" horizontalAlignment="center">
                    ...
                    <label text={data.temperature} fontSize={Math.min(size.width * 0.2, 20)} fontWeight="bold" textAlignment="right" color={widgetColor} horizontalAlignment="center" verticalAlignment="center"></label>
                </stacklayout>
            </gridlayout>
                <label text={data.locationName} fontSize={12} opacity={0.5} maxLines={1} color={widgetColor} horizontalAlignment="left" verticalAlignment="top"></label>
    ...
    {:else}
        <gridlayout padding={3}>
            <stacklayout orientation="vertical">
                    <label fontSize={Math.min(size.height * 0.24, 40)} fontWeight={config.settings?.clockBold === true ? "bold" : "normal"} textAlignment={size.height <= 50 ? "right" : "left"} color={widgetColor} text={nowTime()} horizontalAlignment={size.height <= 50 ? "end" : "center"} verticalAlignment="top"></label>
                <stacklayout orientation="horizontal" horizontalAlignment="center" verticalAlignment="top">
                    ...
                    <label text={data.temperature} fontSize={Math.min(size.width * 0.2, 20)} fontWeight="bold" color={widgetColor} verticalAlignment="center" horizontalAlignment="center"></label>
                </stacklayout>
            ...
            <gridlayout rows="*,auto">
                <label text={data.locationName} fontSize={size.width < 100 ? 8 : size.width < 150 ? 10 : 12} opacity={0.5} maxLines={1} color={widgetColor} row={1} horizontalAlignment="right" verticalAlignment="bottom"></label>
            </gridlayout>
        </gridlayout>
    {/if}
</gridlayout>
