        ...
        <gridlayout paddingLeft={10} paddingRight={10} paddingTop={6} paddingBottom={6}>
            <gridlayout padding={8} columns="auto,*,auto">
                <stacklayout orientation="vertical" col={0} verticalAlignment="center" horizontalAlignment="center">
                    <label fontSize={Math.min(size.width * 0.17, 48)} fontWeight={config.settings?.clockBold == true ? "700" : "400"} color={colorOnSurface} text={formatDateWithoutYear(new Date(), 'll')} horizontalAlignment="left" verticalAlignment="center"></label>
